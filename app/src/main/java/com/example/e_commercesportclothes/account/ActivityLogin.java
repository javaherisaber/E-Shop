...
import com.example.e_commercesportclothes.MainActivity;
...
public class ActivityLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_login);
            ...
            mCreateBtn = findViewById(R.id.textViewGoRegister1);
            forgotTextLink = findViewById(R.id.textViewForget);
        ...
        mCreateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            forgotTextLink.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    final AlertDialog.Builder passwordResetDialog = new Builder(v.getContext());
